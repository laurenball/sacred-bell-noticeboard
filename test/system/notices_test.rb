...
class NoticesTest < ApplicationSystemTestCase
  ...
  test "creating a Notice" do
    ...
    fill_in "Notes", with: @notice.notes
    fill_in "Openings", with: @notice.openings
    fill_in "Requester", with: @notice.requester
    fill_in "Reward", with: @notice.reward
    fill_in "Sessions", with: @notice.sessions

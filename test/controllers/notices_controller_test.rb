...
class NoticesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create notice" do
    assert_difference('Notice.count') do
      post notices_url, params: { notice: { author: @notice.author, notes: @notice.notes, openings: @notice.openings, requester: @notice.requester, reward: @notice.reward, sessions: @notice.sessions, title: @notice.title } }
    end
  ...
  test "should update notice" do
    patch notice_url(@notice), params: { notice: { author: @notice.author, notes: @notice.notes, openings: @notice.openings, requester: @notice.requester, reward: @notice.reward, sessions: @notice.sessions, title: @notice.title } }
